...
export const QA_AGENTS: QaAgent[] = [
  ...
  },
  {
    ...
    emoji: "🎭",
    status: "active",
    description: "Valide chaque feature dans un vrai navigateur headless (scénario e2e.json).",
  },
  {
    id: "monkey",
    name: "Monkey testing",
    ...
    emoji: "🐒",
    status: "active",
    description: "Interactions aléatoires dans le navigateur pour détecter crashs et erreurs JS.",
  },
  {
    id: "static-analysis",
